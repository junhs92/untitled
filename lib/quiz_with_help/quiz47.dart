...
class QWHQuiz47 extends StatefulWidget {
  const QWHQuiz47({Key? key}) : super(key: key);

  @override
  State<QWHQuiz47> createState() => _QWHQuiz47State();
}

class _QWHQuiz47State extends State<QWHQuiz47> {
