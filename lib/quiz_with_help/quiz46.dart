...
class QWHQuiz46 extends StatefulWidget {
  const QWHQuiz46({Key? key}) : super(key: key);

  @override
  State<QWHQuiz46> createState() => _QWHQuiz46State();
}

class _QWHQuiz46State extends State<QWHQuiz46> {
    ...
    return Scaffold(
        ...
        body: Column(
          children: [
            ...
            Image.asset('assets/images/with_help/show_triangle.PNG'),
            Container(
              ...
              child: Container(
                decoration: BoxDecoration(
                    image: DecorationImage(
                        ...
                        image: AssetImage('assets/images/with_help/show_triangle2.PNG'))
                ),
